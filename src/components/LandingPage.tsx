          ...
          <div className="text-center space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4">
              <button
                ...
                className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 transition"
              >
                Login
              </button>
              <button
                onClick={() => onNavigate('signup')}
                className="w-full sm:w-auto px-6 sm:px-8 py-3 bg-white text-indigo-600 rounded-lg font-semibold border-2 border-indigo-600 hover:bg-indigo-50 transition"
              >
                Get Started
              </button>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
            ...
            <p className="text-sm sm:text-base text-gray-600">
              Organize tickets by priority and status to focus on what matters most.
            </p>
          </div>
        </div>
      </div>
